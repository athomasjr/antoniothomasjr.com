...
featuredImage: healthy-habits.png
embeddedImagesLocal:
  - foam-rollers.jpeg
  - plank.jpeg
  - half-cobra.jpeg
...
Have you experienced back pain working in web development? You could be powering through some discomfort as you read this.

<Highlight >Let's change that!</Highlight>
...
<Highlight>Okay, Antonio, I get it, what's the cost?</Highlight>
...
> For more check out **[SPINE-health](https://www.spine-health.com/wellness/ergonomics/office-chair-choosing-right-ergonomic-office-chair)**
...
<Header>How do You Improve your Static Posture?</Header>
...
<Header>Exercises to try that have proven to improve posture:</Header>

<Highlight>Planks</Highlight>

<BlogImg  alt="Man performing planks on a bridge" image={props.localImages[1]} />
...
<Highlight>Half Cobra Pose</Highlight>


<BlogImg alt="woman in half cobra pose" image={props.localImages[2]} />
...
<Highlight>Foam Roller</Highlight>

<BlogImg alt="foam rollers in a line" image={getImage(props.localImages[0])} />
...
<BlogImg  image={props.localImages[3]} alt='man starting stages of deadlift'  />
...
⬇️ For more resources to help you move forward in web development.
