...
<GatsbyImage alt="Man performing planks on a bridge" image={getImage(props.localImages[1])} />
...
<GatsbyImage alt="woman in half cobra pose" image={getImage(props.localImages[2])} />
...
<GatsbyImage alt="man starting stages of deadlift" image={getImage(props.localImages[3])} />
</div>
