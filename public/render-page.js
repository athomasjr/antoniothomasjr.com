...
var plugins = [{
  ...
  options: {
    ...
    "root": "/Users/antoniothomas/Desktop/antoniothomasjr.com"
  }
}, {
  ...
  plugin: __webpack_require__(/*! ./node_modules/gatsby-plugin-csp/gatsby-ssr */ "./node_modules/gatsby-plugin-csp/gatsby-ssr.js"),
  options: {
    "plugins": [],
...
/***/ "./node_modules/gatsby-plugin-csp/gatsby-ssr.js":
/*!******************************************************!*\
  !*** ./node_modules/gatsby-plugin-csp/gatsby-ssr.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const flatten = __webpack_require__(/*! lodash.flatten */ "./node_modules/lodash.flatten/index.js");

const _require = __webpack_require__(/*! ./utils */ "./node_modules/gatsby-plugin-csp/utils.js"),
...
/***/ "./node_modules/gatsby-plugin-csp/utils.js":
/*!*************************************************!*\
  !*** ./node_modules/gatsby-plugin-csp/utils.js ***!
  \*************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
async function staticPage(pagePath, isClientOnlyPage, publicDir, error, callback) {
  ...
  if (error) {
    postBodyComponents.push([/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default().createElement("script", {
      key: "dev-ssr-error",
      dangerouslySetInnerHTML: {
    ...
    }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default().createElement("noscript", {
      key: "dev-ssr-error-noscript"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default().createElement("h1", null, "Failed to Server Render (SSR)"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default().createElement("h2", null, "Error message:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default().createElement("p", null, error.sourceMessage), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default().createElement("h2", null, "File:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default().createElement("p", null, error.source, ":", error.line, ":", error.column), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default().createElement("h2", null, "Stack:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default().createElement("pre", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default().createElement("code", null, error.stack)))]);
  }
  ...
  const generateBodyHTML = async () => {
    ...
    let scriptsAndStyles = lodash_flatten__WEBPACK_IMPORTED_MODULE_3___default()([`commons`].map(chunkKey => {
      ...
      return chunks;
    })).filter(s => lodash_isObject__WEBPACK_IMPORTED_MODULE_4___default()(s)).sort((s1, _s2) => s1.rel == `preload` ? -1 : 1); // given priority to preload
    ...
    class RouteHandler extends (react__WEBPACK_IMPORTED_MODULE_7___default().Component) {
      render() {
        ...
        const wrappedPage = (0,_api_runner_ssr__WEBPACK_IMPORTED_MODULE_11__.apiRunner)(`wrapPageElement`, {
          element: pageElement,
          props
        }, pageElement, ({
          result
    ...
    const bodyComponent = (0,_api_runner_ssr__WEBPACK_IMPORTED_MODULE_11__.apiRunner)(`wrapRootElement`, {
    ...
    await (0,_api_runner_ssr__WEBPACK_IMPORTED_MODULE_11__.apiRunnerAsync)(`replaceRenderer`, {
      bodyComponent,
    ...
    (0,_api_runner_ssr__WEBPACK_IMPORTED_MODULE_11__.apiRunner)(`onRenderBody`, {
      setHeadComponents,
      setHtmlAttributes,
      setBodyAttributes,
      setPreBodyComponents,
    ...
    (0,_api_runner_ssr__WEBPACK_IMPORTED_MODULE_11__.apiRunner)(`onPreRenderHTML`, {
      getHeadComponents,
      replaceHeadComponents,
      getPreBodyComponents,
  ...
  const htmlElement = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default().createElement(Html, _objectSpread(_objectSpread({}, bodyProps), {}, {
    ...
    bodyAttributes,
    preBodyComponents,
    postBodyComponents: postBodyComponents.concat([ true && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default().createElement("script", {
      key: `polyfill`,
      src: "/polyfill.js",
      noModule: true
